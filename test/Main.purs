...
import Erl.Rand (Alg(..), RandState, bytes, bytes', bytesS, bytesS', normal, normal', normal01, normal01S, normalS, normalS', seed, uniform, uniformRange, uniformRangeS, uniformS, uniformTo, uniformTo', uniformToS, uniformToS')
